...
const main = async () => {
  ...
  const txBuy721Marketplace = await contractERC721NFTMarketplaceSigner3.createBidUsingEth(ADDRESS_ERC721U2U, tokenId, price, { value: totalPrice });
